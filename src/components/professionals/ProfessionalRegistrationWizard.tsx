          ...
          <div className="space-y-4">
            <div className="p-4 bg-zinc-50 dark:bg-zinc-800/50 border border-[#E8EBE7] dark:border-white/5 rounded-xl">
              <p className="text-xs font-bold text-zinc-500 uppercase tracking-wider mb-3 flex items-center gap-1.5">
                <Upload className="w-3.5 h-3.5" /> Profile Images (URL)
              </p>
              <p className="text-xs text-zinc-400 mb-3">
                Paste image URLs. You can update these later from your dashboard. Supported: Cloudinary, Supabase Storage, or any public image URL.
              </p>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                ...
                <div>
                  <label className="label-style">Cover Image URL</label>
                  <input
                    type="url"
                    value={coverImage}
