...
import { User, Shield, Bell, Trash2, Eye, EyeOff, Loader2, CheckCircle } from "lucide-react";
...
export default function UserSettingsForm({ profile, user }: UserSettingsFormProps) {
          ...
          <div className="glass-card p-6 bg-white border border-[#E8EBE7] shadow-sm space-y-8">
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <p className="text-sm text-zinc-700 font-bold capitalize">{profile?.role || "User"}</p>
                </div>
              </div>
            </div>
            ...
            <div className="border-t border-red-100 pt-6">
              ...
              <p className="text-zinc-500 text-sm mb-4">
                Permanently delete your OakTix account and all related booking/ticket records. This action cannot be undone.
              </p>
              <button
                type="button"
          ...
          <div className="glass-card p-6 bg-white border border-[#E8EBE7] shadow-sm">
            ...
            <div className="space-y-4">
              <label className="flex items-start gap-3 p-3 rounded-xl hover:bg-zinc-50 transition-all cursor-pointer">
                ...
                <div>
                  <p className="font-bold text-sm text-zinc-800">Email ticket purchase confirmations</p>
                  <p className="text-xs text-zinc-500">Receive an email immediately after buying tickets to an event.</p>
                </div>
              </label>
              ...
              <label className="flex items-start gap-3 p-3 rounded-xl hover:bg-zinc-50 transition-all cursor-pointer">
                <input type="checkbox" defaultChecked className="mt-1 w-4 h-4 rounded text-indigo-600 border-zinc-300 focus:ring-indigo-500" />
                <div>
                  <p className="font-bold text-sm text-zinc-800">Event updates & notices</p>
                  <p className="text-xs text-zinc-500">Get announcements from event organizers for tickets you hold.</p>
                </div>
              </label>
              ...
              <label className="flex items-start gap-3 p-3 rounded-xl hover:bg-zinc-50 transition-all cursor-pointer">
                ...
                <div>
                  <p className="font-bold text-sm text-zinc-800">General promotion bulletins</p>
                  <p className="text-xs text-zinc-500">Stay informed about new event discovery recommendations.</p>
                </div>
              </label>
            </div>
          </div>
